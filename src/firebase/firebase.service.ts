...
export class FirebaseService implements OnModuleInit {
  ...
  //     // Create DB record with PENDING status for all channels
  ...
  //           await this.handlePushChannel(payload, notificationDoc._id);
  //         }
  ...
  //         this.logger.error(
  //           `Channel ${channel} failed: ${err.message}`,
  //         );
  //       }
  //     }
  ...
  //     const statuses = Object.values(updatedDoc.channelStatus);

  //     const finalStatus = statuses.includes(NotificationStatus.FAILED)
  //       ? NotificationStatus.FAILED
  //       : NotificationStatus.SENT;
  ...
  //     const finalDoc = await this.notificationRepository.findById(
  //       notificationDoc._id.toString(),
  //     );
  //     this.logger.log(`Notification processed with status: ${finalStatus}`);
  //     return {
  //       success: true,
  ...
  // Helper method to handle push notifications and cleanup invalid tokens
